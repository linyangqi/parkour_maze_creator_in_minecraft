...
#提示
tellraw @a [{"underlined":True,"color":"yellow","text":"\n[[[ end 提前停止 ]]]","clickEvent":{"action":"suggest_command","value":"/function parkour_maze:end"}}]
#tellraw @s [{"underlined":True,"color":"yellow","text":"\n[[[ real reload to stop  ]]]","clickEvent":{"action":"suggest_command","value":"/function parkour_maze:reload"}}]
